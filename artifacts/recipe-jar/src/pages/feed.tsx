...
import { Search, UtensilsCrossed, Sparkles, X, ArrowUpDown } from "lucide-react";
...
export default function FeedPage() {
  ...
  const activeFilterCount = [selectedCuisine, selectedDifficulty, selectedTime, selectedDiet, debouncedSearch]
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="bg-white rounded-2xl border border-neutral-100 shadow-sm p-5 mb-5 flex flex-col gap-4">
        <PillGroup
          label="Cuisine"
        ...
        <div className="flex items-center gap-3">
          {hasFilters ? (
            <button
              ...
              className="flex items-center gap-1.5 text-xs font-medium text-neutral-500 hover:text-neutral-700 bg-neutral-100 hover:bg-neutral-200 px-3 py-1.5 rounded-full transition-all duration-200"
            >
              <X className="w-3.5 h-3.5" />
              Clear all
              <span className="ml-0.5 bg-orange-500 text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-bold">
                {activeFilterCount}
              </span>
            </button>
          ) : (
